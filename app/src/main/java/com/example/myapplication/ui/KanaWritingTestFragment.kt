...
@AndroidEntryPoint
class KanaWritingTestFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Get all kana characters and shuffle
        currentQuizList = viewModel.getAllKanaList().toMutableList()
    ...
    private fun displayProblem() {
        ...
        binding.checkboxSelect.isChecked = viewModel.isKanaSelected(kana)

        // Handle checkbox selection
        binding.checkboxSelect.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked != viewModel.isKanaSelected(kana)) {
